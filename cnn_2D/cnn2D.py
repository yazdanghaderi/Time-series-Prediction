...
with g.as_default():
    ...
    L1=tf.layers.conv2d(inputs=X,filters=64,kernel_size=(2,2),strides=(1,1),padding='valid',activation='relu', data_format='channels_last', dilation_rate=1, use_bias=True, kernel_initializer='glorot_uniform', bias_initializer='zeros')
    ...
    #
    # L2=tf.layers.conv2d(inputs=L1,filters=64,kernel_size=(2,2),strides=(1,1),padding='valid',activation='relu', data_format='channels_last', dilation_rate=1, use_bias=True, kernel_initializer='glorot_uniform', bias_initializer='zeros')
