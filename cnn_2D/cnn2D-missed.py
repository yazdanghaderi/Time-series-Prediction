...
with g.as_default():
    ...
    X = tf.placeholder(tf.float32, [None, num_periods, inputs,1])
    # filt=tf.placeholder(tf.float32, [None, num_periods, inputs])
    y = tf.placeholder(tf.float32, [None, output])

    L1=tf.layers.conv2d(inputs=X,filters=44,kernel_size=(2,2),strides=(1,1),padding='valid',activation='relu', data_format='channels_last', dilation_rate=1, use_bias=True, kernel_initializer='glorot_uniform', bias_initializer='zeros')
    # L2=tf.layers.max_pooling1d(inputs=L1,pool_size=2,strides=1)
    L1=tf.layers.max_pooling2d(inputs=L1,pool_size=(2,2), strides=(1,1), padding='valid', data_format='channels_last')
    L1=tf.nn.dropout(L1,keep_prob=0.8)
    # keras.layers.Conv1D(filters, kernel_size, strides=1, padding='valid', data_format='channels_last', dilation_rate=1, activation=None, use_bias=True, kernel_initializer='glorot_uniform', bias_initializer='zeros', kernel_regularizer=None, bias_regularizer=None, activity_regularizer=None, kernel_constraint=None, bias_constraint=None)

    L2=tf.layers.conv2d(inputs=L1,filters=44,kernel_size=(2,2),strides=(1,1),padding='valid',activation='relu', data_format='channels_last', dilation_rate=1, use_bias=True, kernel_initializer='glorot_uniform', bias_initializer='zeros')
    # # L5=tf.layers.max_pooling1d(inputs=L4,pool_size=2,strides=1)
    L2=tf.layers.max_pooling2d(inputs=L2,pool_size=(2,2), strides=(1,1), padding='valid', data_format='channels_last')
    L2=tf.nn.dropout(L2,keep_prob=0.8)
    #
    # L3 = tf.layers.conv1d(inputs=L2, filters=64, kernel_size=(2,2), strides=(1,1), padding='valid', activation='relu',
    #                       data_format='channels_last', dilation_rate=1, use_bias=True,
    #                       kernel_initializer='glorot_uniform', bias_initializer='zeros')
    # # L5=tf.layers.max_pooling1d(inputs=L4,pool_size=2,strides=1)
    # L3 = tf.layers.max_pooling2d(inputs=L3, pool_size=(2, 2), strides=(1, 1), padding='valid',
    #                              data_format='channels_last')
    # L3 = tf.nn.dropout(L3, keep_prob=0.8)

    flatt=tf.layers.flatten(inputs=L2)
